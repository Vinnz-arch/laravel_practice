<x-layouts.app :title="__('Dashboard')">
            ...
            <div class="relative overflow-hidden rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-neutral-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="mt-2 text-3xl font-bold text-neutral-900 dark:text-neutral-100">{{ $mens->count() }}</h3>
                    </div>
        ...
        <div class="relative h-full flex-1 overflow-hidden rounded-xl border border-neutral-200 bg-white dark:border-neutral-700 dark:bg-neutral-800">
            <div class="flex h-full flex-col p-6">
                ...
                <div class="mb-6 rounded-lg border border-neutral-200 bg-neutral-50 p-6 dark:border-neutral-700 dark:bg-neutral-900/50">
                    ...
                    <form method="POST" action="{{ route('mens.store') }}" class="grid gap-4 md:grid-cols-2">
                        @csrf
                        <div>
                            ...
                            <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                                @forelse($mens as $men)
                                    <tr class="transition-colors hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
                                        <td class="px-4 py-3 text-sm text-neutral-600 dark:text-neutral-400">{{ $men->id }}</td>
                                        <td class="px-4 py-3 text-sm text-neutral-900 dark:text-neutral-100">{{ $men->name }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-4 py-3 text-center text-sm text-neutral-600 dark:text-neutral-400">No mens found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
    ...
    {{-- Modal --}}
    <!-- Edit Modal -->
    <div id="editModal" class="fixed inset-0 hidden justify-center items-center z-50 mb-6 rounded-lg border border-neutral-200 bg-neutral-50 p-6 dark:border-neutral-700 dark:bg-neutral-900/50">
        <div class="bg-white dark:bg-neutral-900 p-6 rounded-lg w-full max-w-md shadow-lg">
            <h2 class="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mb-4">Edit Men</h2>
            ...
            <form id="editForm" method="POST">
                ...
                <div class="mb-3">
                    <label class="mb-2 block text-sm font-medium text-neutral-700 dark:text-neutral-300">Name</label>
                    <input id="editName" type="text" name="name" class="w-full rounded-lg border border-neutral-300 bg-white px-4 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-100" required>
                </div>
                <div class="mb-3">
                    <label class="mb-2 block text-sm font-medium text-neutral-700 dark:text-neutral-300">Email</label>
                    <input id="editEmail" type="email" name="email" class="w-full rounded-lg border border-neutral-300 bg-white px-4 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-100" required>
                </div>
                <div class="mb-3">
                    <label class="mb-2 block text-sm font-medium text-neutral-700 dark:text-neutral-300">Phone</label>
                    <input id="editPhone" type="text" name="phone" class="w-full rounded-lg border border-neutral-300 bg-white px-4 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-100" required>
                </div>

                <div class="mb-3">
                    <label class="mb-2 block text-sm font-medium text-neutral-700 dark:text-neutral-300">Address</label>
                    <input id="editAddress" type="text" name="address" class="w-full rounded-lg border border-neutral-300 bg-white px-4 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-100" required>
                </div>

                <div class="flex justify-end gap-2">
                    <button type="button" onclick="closeModal()" class="px-4 py-2 bg-gray-300 dark:bg-neutral-700 text-gray-700 dark:text-gray-200 rounded">Cancel</button>
    ...
    <script>
        function openEditModal(id, name, email, phone, address) {
            ...
            document.getElementById('editForm').action = `/mens/${id}`;
        }
